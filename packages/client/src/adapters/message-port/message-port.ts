 ...
 */
export type SupportedMessagePortData = object | string | ArrayBufferLike | Uint8Array

export function postMessagePortMessage(port: SupportedMessagePort, data: SupportedMessagePortData, options?: StructuredSerializeOptions): void {
  port.postMessage(data, options)
}
