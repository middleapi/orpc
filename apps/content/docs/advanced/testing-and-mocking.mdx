...
:::info
`implement` is also useful for building mock servers in frontend tests. To mock at the network level instead, for example in Storybook stories or browser tests, use the [MSW Integration](/docs/integrations/msw).
:::
