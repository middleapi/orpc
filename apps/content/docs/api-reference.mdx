...
| Package | Purpose | Related Guides |
| ------- | ------- | -------------- |
| [@orpc/cache](https://npmx.dev/package-docs/@orpc/cache) | Tag-based caching and revalidation with memory, Redis, and Vercel adapters. | [Cache](/docs/helpers/cache) |
...
| [@orpc/cloudflare](https://npmx.dev/package-docs/@orpc/cloudflare) | Cloudflare KV, Cache API, Workers Caching, Durable Object, and Rate Limit adapters. | [Cache](/docs/helpers/cache), [Publisher](/docs/helpers/publisher), [Rate Limit](/docs/helpers/ratelimit) |
