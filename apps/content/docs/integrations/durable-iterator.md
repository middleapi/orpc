...
::: info
How to use `DurableIteratorObject` without extending it: [see here](https://github.com/middleapi/orpc/tree/1.x/packages/durable-iterator/src/durable-object/object.ts)
:::
